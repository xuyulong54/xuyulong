...
<head>
	...
	/*页面分类*/
	$(document).ready(function() { setPageType('.mer-receivable', '.mer-receivable-transfer '); })
	//时间控制
...
<body onload="getNowDay();">
  ...
  <div class="container">
	  <div class="bd-container">
		  <form action="merchantReceiveTransfer_listReceiveTransfer.action" method="post" id="form">
		      ...
		      <div class="title">转账记录查询</div>
				...
				<div class="search-top">
					<a id="exportExecl"
						href="merchantReceiveTransfer_exportReceiveTransferToExcel.action?beginDate=${beginDate}&endDate=${endDate}&trxNo=${trxNo}"
		      ...
		      <p>转账金额合计：<span class="text-warning">
		      	<fmt:formatNumber value="${empty countResultMap.successamount?0.00:countResultMap.successamount}" pattern="#0.00"></fmt:formatNumber></span> 元
		    	</p>
		    </div>
			</form>
				...
				<c:if test="${pageBean.totalCount>0}">
					<div class="pageCla">
						<z:page pageBean="${pageBean}"
							url="merchantReceiveTransfer_listReceiveTransfer.action"
							currentPage="${pageNum }"
