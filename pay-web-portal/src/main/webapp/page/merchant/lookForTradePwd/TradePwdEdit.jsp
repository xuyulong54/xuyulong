...
<div class="bd-container">
	...
	<div class=" editBox editBoxWrap">
		...
		<div class="ht"></div>
		<form id="form1" action="merchantlookfortradepwd_editTradePwd.action" method="post">
		<div class="frm-comon">
