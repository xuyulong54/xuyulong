...
<body>
	<p class="clearfix">
		...
		<a href="merchantlookfortradepwd_tradePwdListWay.action"
			class='mtop10 link-color'> &nbsp;忘记支付密码？</a>
	</p>
	<p > <label>&nbsp;</label>
      <span id="errorMsg" class="markRed"></span>
       </p>
			...
			<div class="right-box">
				...
				<p id="p-hint">
					...
					<font id="hint-content" class="font txt-color"> <label>
							您没有安装数字证书！</label><a href='merchantca_listCA.action' class="link-color"><font>点击申请</font>
					</a> </font>
				</p>
...
<script type="text/javascript">
	$(function() {
		var type = '${currentUser.userType}';
		if (type == 3) {
			$('.forgetpasd').attr('href',
					'memberlookfortradepwd_tradePwdListWay.action');
		}
	})
	var autoCA = new AutoCA('${IS_SN_USER}', '${CURRENT_SN}', 'form1', $(
			"#transferAmount").val(), $("#payeeAccountNo").val());
	function subForm() {
