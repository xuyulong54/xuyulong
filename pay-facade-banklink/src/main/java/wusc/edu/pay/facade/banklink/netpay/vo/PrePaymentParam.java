 ...
 * 
 */
public class PrePaymentParam implements Serializable {
	...
	public void checkValue(){
		...
		/** 客户银行账户 */
		/*if(StringUtils.isBlank(this.payerBankAccountNo)){
			throw BankLinkBizException.PAYER_BANKACCOUNTNO_IS_NULL;
		}*/
		/** 商户编号 */
		/*if(StringUtils.isBlank(this.merchantNo)){
			throw BankLinkBizException.MERCHANTNO_IS_NULL;
		}*/
		/**下单日期*/
		...
		/*if(this.currency == null ){
			throw BankLinkBizException.CURRENCY_IS_NULL;
		}*/
		/**金额*/
