...
<div class="pageContent">
		<div class="pageFormContent" layoutH="60">
			...
			<div class="unit">
				...
				<s:textfield name="openBank" cssClass="required" value="%{model.openBank }"  readonly="true" 
					minlength="6" maxlength="30" style="width: 50%" />
			</div>
			<div class="unit">
				<label style="width: 20%;text-align: right;">开户行地址：</label> 
				<s:textfield name="openBankAddress" cssClass="required" value="%{model.openBankAddress }"  readonly="true"  minlength="6" maxlength="90" style="width: 50%" />
			</div>
			<div class="unit">
				<label style="width: 20%;text-align: right;">开户日期：</label>
				<input type="text" readonly="true" style="width: 50%" value='<fmt:formatDate value="${model.opendate }" pattern="yyyy-MM-dd"/>'>
			</div>
			<div class="unit">
				<label style="width: 20%;text-align: right;">银行账号：</label> 
				<s:textfield name="bankAccount" cssClass="required" value="%{model.bankAccount }"  readonly="true" 
			...
			<div class="unit">
				...
				<label><input type="radio"  onclick="return false" <c:if test="${model.cooperationWay eq 1 }">checked="checked"</c:if> name="cooperationWay" value="1">存管银行</label>
				<label><input type="radio"  onclick="return false" <c:if test="${model.cooperationWay eq 2 }">checked="checked"</c:if> name="cooperationWay" value="2">合作银行 </label>
			</div>
			<div class="unit">
			...
			<div class="unit">
				...
				<select name="accountStatus" disabled="disabled" >
			...
			<div class="unit">
				...
				<label><input type="radio"  onclick="return false" <c:if test="${model.accountType eq 1 }">checked="checked"</c:if>  name="accountType" value="1">活期</label>
				<label><input type="radio"  onclick="return false" <c:if test="${model.accountType eq 2 }">checked="checked"</c:if>  name="accountType" value="2">定期</label>
				<label><input type="radio"  onclick="return false" <c:if test="${model.accountType eq 3 }">checked="checked"</c:if>  name="accountType" value="3">通支</label>
			</div>
			<div class="unit">
			...
			<div class="unit">
				...
				<s:textfield name="accountMngFee" value="%{model.accountMngFee }"  readonly="true" cssClass="required number" maxlength="10" style="width: 50%" />
			</div>
			<div class="unit">
			...
			<div class="unit">
				...
				<s:textfield name="linkMan" value="%{model.linkMan }"  readonly="true"  cssClass="required"  minlength="1" maxlength="50" style="width: 50%" />
			</div>
			<div class="unit">
			...
			<div class="unit">
				...
				<s:textfield name="bigAmounttransferObligate" value="%{model.bigAmounttransferObligate }"  readonly="true"  cssClass="required" minlength="6" maxlength="60" style="width: 50%" />
			</div>
			<div class="unit">
				<label style="width: 20%;text-align: right;">质押保证金：</label>
				<fmt:formatNumber value="${model.pledgefDeposits }" pattern="0.00"/>
			</div>
			<div class="unit">
			...
			<div class="unit">
				...
				<s:textarea name="comments" value="%{model.comments }"   readonly="true"  maxlength="100" rows="3" cols="45"></s:textarea>
			</div>
		</div>
		<div class="formBar">
			<ul>
