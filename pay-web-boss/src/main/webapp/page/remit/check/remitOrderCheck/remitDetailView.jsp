...
<div class="pageContent">
	<form id="form" method="post"
		action="remitOrderCheck_remitDoCheck.action"
		class="pageForm required-validate"
		onsubmit="return validateCallback(this, dialogAjaxDone);">
		<input type="hidden" name="navTabId" value="remitOrderCheckList">
		...
		<div class="pageFormContent" layoutH="60">
			...
			<%-- <p>
				...
				<input type='text' id='isUrgent' value='${v.desc}' size='30' name='isUrgent'  readonly="readonly" />
				</c:if></c:forEach>
			</p> --%>
			<p>
...
<script type="text/javascript">
	...
	function onSubmit(doFlag , id){
			var url = "remitOrderCheck_remitDoCheck.action?flag=2";
			if(doFlag == '1'){
				document.getElementById('passOrders').value=id;
				url = url + "&passOrders=" + id;
			}else if(doFlag == '2'){
				document.getElementById('rejectOrders').value=id;
				url = url + "&rejectOrders=" + id;
			}
